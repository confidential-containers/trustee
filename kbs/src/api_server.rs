...
use crate::{
    ...
    prometheus::{
        REQUEST_DURATION, REQUEST_SIZES, REQUEST_TOTAL, RESOURCE_POLICY_ERRORS,
        RESOURCE_POLICY_EVALS, RESOURCE_POLICY_VIOLATIONS,
    },
    token::TokenVerifier,
    Error, Result,
};
        ...
        plugin_name => {
                ...
                .map_err(|e| Error::PluginInternalError { source: e })?
            {
                ...
                if !core
                    ...
                    .await
                    .inspect_err(|_| RESOURCE_POLICY_ERRORS.inc())?
                {
