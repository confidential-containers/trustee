...
pub(crate) trait PolicyEngineInterface: Send + Sync {
    ...
    /// Input parameters:
    /// accessed_path: Required to be a string in segments path format:<FIRST>/.../<END>, for example: "my'repo/License/key".
