...
mod tests {
    ...
    fn compare_errors(a: KbsPolicyEngineError, b: KbsPolicyEngineError) -> bool {
        match (a, b) {
            ...
            (KbsPolicyEngineError::RequestDataError, KbsPolicyEngineError::RequestDataError) => {
                true
            }
