...
use crate::snp::{
    get_common_name, get_oid_int, get_oid_octets, ProcType, CERT_CHAINS, HW_ID_OID, LOADER_SPL_OID,
    SNP_SPL_OID, TEE_SPL_OID, UCODE_SPL_OID,
};
...
mod tests {
    ...
    fn test_verify_snp_report() {
        ...
        let vendor_certs = CERT_CHAINS.get(&ProcType::Milan).unwrap().clone();
