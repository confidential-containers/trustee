...
- `trusted_ak_keys_dir` (optional): Directory containing trusted AK public keys in base64 format
...
- To change the default limit system-wide, modify the `MAX_TRUSTED_AK_KEYS` constant in `mod.rs`