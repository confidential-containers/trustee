        ...
        match report {
            AttestationReport::V1(attestation_report_v1) => {
                ...
                let claims = json!({
                    ...
                    "user_pubkey_digest": hex::encode(xor_with_anonce(&attestation_report_v1.tee_info.user_pubkey_digest, anonce)),
                    "vm_id": hex::encode(xor_with_anonce(&attestation_report_v1.tee_info.vm_id, anonce)),
                    "vm_version": hex::encode(xor_with_anonce(&attestation_report_v1.tee_info.vm_version, anonce)),
                    "report_data": hex::encode(xor_with_anonce(&attestation_report_v1.tee_info.vm_version, anonce)),
                    "mnonce": hex::encode(xor_with_anonce(&attestation_report_v1.tee_info.vm_version, anonce)),
                    "measure": hex::encode(xor_with_anonce(&attestation_report_v1.tee_info.vm_version, anonce)),
                    "sig_usage": hex::encode(attestation_report_v1.tee_info.sig_usage.to_le_bytes()),
                    "sig_algo": hex::encode(attestation_report_v1.tee_info.sig_algo.to_le_bytes()),
            ...
            AttestationReport::V2(attestation_report_v2) => {
                ...
                let mut claims = json!({
                    ...
                    "user_pubkey_digest": hex::encode(attestation_report_v2.tee_info.user_pubkey_digest),
                    "vm_id": hex::encode(attestation_report_v2.tee_info.vm_id),
                    "vm_version": hex::encode(attestation_report_v2.tee_info.vm_version),
                    "report_data": hex::encode(attestation_report_v2.tee_info.report_data),
                    "mnonce": hex::encode(attestation_report_v2.tee_info.mnonce),
                    "measure": hex::encode(attestation_report_v2.tee_info.measure),
                    "sig_usage": hex::encode(attestation_report_v2.tee_info.sig_usage.to_le_bytes()),
                    "sig_algo": hex::encode(attestation_report_v2.tee_info.sig_algo.to_le_bytes()),
