...
#[case::basic_simple_allow_all(
    KbsConfigType::SimpleTokenBuiltInRvps,
    PolicyType::AllowAll,
    vec![],
    false,
    DEFAULT_SIMPLE_ATTESTATION_POLICY,
    None,
    Result::Ok(SECRET_BYTES)
)]
...
const EAR_CONTRAINDICATED_ATTESTATION_POLICY: &str = "
package policy
import rego.v1
...
const EAR_RV_ATTESTATION_POLICY: &str = "
package policy
import rego.v1
...
const DEFAULT_SIMPLE_ATTESTATION_POLICY: &str = "
package policy
import rego.v1
