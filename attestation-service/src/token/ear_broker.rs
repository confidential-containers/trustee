    ...
    async fn issue(
        ...
        for tee_claims in all_tee_claims {
            ...
            tee_class_indices
                ...
                .or_insert(0);
            let tee_class_index = *tee_class_indices.get_mut(&tee_claims.tee_class).unwrap();
            tee_class_indices.insert(tee_claims.tee_class.clone(), tee_class_index + 1);

            let submod_name = format!("{}{}", tee_claims.tee_class, tee_class_index.clone());
