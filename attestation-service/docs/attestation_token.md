...
`cpu0` Appraisal. Parsed / validated JSON (when plaintext was provided and
bound) is under `ear_verifier_claims`:

- raw hash / report bytes: `ear_attester_claims.init_data`, `ear_attester_claims.report_data`
- TEE type and hardware object: `ear_attester_claims.tee`, `ear_attester_claims.claims`
- parsed objects: `ear_verifier_claims.init_data`, `ear_verifier_claims.runtime_data`
