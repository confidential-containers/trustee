...
You may either download it from a browser by pasting that URL, or you can run
...
Use docker commands to copy your `vcek` folder (making sure to add the ending
`/` in both paths) into the directory that you specified in the configuration:
```
