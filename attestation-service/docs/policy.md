...
```json
{
    ...
    "index": "<index-of-extension">,
    "value": ...
}
```
The extension index should be an i32.
If the extension is registered in the EAR specification, the index will be positive.
Otherwise, the index should be negative.
