...
/// `Extractors` process provenance messages. An extractor takes
/// a particular type of provenance, such as in-toto, verifies its
/// authenticity, and returns a reference value.
/// If the verification fails, no reference value is returned.
#[derive(Default)]
