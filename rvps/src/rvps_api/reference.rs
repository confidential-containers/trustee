...
pub mod reference_value_provider_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn query_reference_values(
            &mut self,
            request: impl tonic::IntoRequest<super::ReferenceValuesQueryRequest>,
        ) -> std::result::Result<tonic::Response<super::ReferenceValueQueryResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/reference.ReferenceValueProviderService/QueryReferenceValues",
            );
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "reference.ReferenceValueProviderService",
...
pub mod reference_value_provider_service_server {
        ...
        std::marker::Send + std::marker::Sync + 'static
    {
        ...
        async fn query_reference_values(
            &self,
            request: tonic::Request<super::ReferenceValuesQueryRequest>,
        ) -> std::result::Result<tonic::Response<super::ReferenceValueQueryResponse>, tonic::Status>;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/reference.ReferenceValueProviderService/QueryReferenceValues" => {
                    #[allow(non_camel_case_types)]
                    struct QueryReferenceValuesSvc<T: ReferenceValueProviderService>(pub Arc<T>);
                    impl<T: ReferenceValueProviderService>
                        tonic::server::UnaryService<super::ReferenceValuesQueryRequest>
                        for QueryReferenceValuesSvc<T>
                    {
                        type Response = super::ReferenceValueQueryResponse;
                        type Future = BoxFuture<tonic::Response<Self::Response>, tonic::Status>;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ReferenceValueProviderService>::query_reference_values(
                                    &inner, request,
                                )
                                .await
                            };
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = QueryReferenceValuesSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
